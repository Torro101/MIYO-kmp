package org.koharu.miyo.suggestions.ui
...
import org.koharu.miyo.core.util.ext.takeMostFrequent
import org.koharu.miyo.core.util.ext.toBitmapOrNull
import org.koharu.miyo.core.util.ext.trySetForeground
...
import org.koharu.miyo.settings.work.PeriodicWorkScheduler
import org.koharu.miyo.suggestions.domain.MangaSuggestion
import org.koharu.miyo.suggestions.domain.SuggestionRepository
import org.koharu.miyo.suggestions.domain.TagsBlacklist
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "org.koharu.miyo.SUGGESTIONS"
