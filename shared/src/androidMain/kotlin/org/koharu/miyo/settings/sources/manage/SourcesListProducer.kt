package org.koharu.miyo.settings.sources.manage
...
class SourcesListProducer @Inject constructor(
	...
	private suspend fun buildList(): List<SourceConfigItem> {
		val enabledSources = repository.getEnabledSources().filter {
            ...
            unwrapped !is org.koharu.miyo.core.parser.external.ExternalMangaSource &&
            unwrapped !is org.koharu.miyo.core.model.LocalMangaSource &&
            unwrapped !is org.koharu.miyo.core.model.TestMangaSource &&
            unwrapped !is org.koharu.miyo.core.model.UnknownMangaSource
        }
